                ...
                <div className="card w-11/12 lg:w-2/5 md:w-2/4 bg-secondary shadow-xl rounded-lg">
                    <div className="card-body p-5">
                        <form onSubmit={handleSubmit}>
                            ...
                            <input className='btn w-full mt-5 border-2 text-white hover:text-[#106731] font-bold px-4 py-2 rounded-lg uppercase bg-[#106731] hover:border-[#106731] hover:bg-white duration-200' disabled={isLoading} type="submit" value="Login" />
                        ...
                        <button className='btn w-full mt-5 border-2 text-[#106731] border-[#106731] font-bold px-4 py-2 rounded-lg uppercase hover:text-white hover:bg-[#106731] duration-200' disabled={isLoading}><Link to='/signup'>Sign Up</Link></button>
                    </div>
                </div>
            </div >
        </div>
